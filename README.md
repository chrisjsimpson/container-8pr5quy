...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-8pr5quy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-8pr5quy.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-8pr5quy.git
cd container-8pr5quy
```
...
```
docker attach container-8pr5quy
```
